...
Replace this section with the supported versions for `actiontaint`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `actiontaint` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in actiontaint.
